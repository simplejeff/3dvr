...
INCLUDEPATH += src libs glm libraries libraries/openvr/headers libs/glew-1.10.0/include
DEPENDPATH += src libs glm libraries libraries/openvr/headers libs/glew-1.10.0/include
